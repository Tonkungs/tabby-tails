        ...
        <div className='flex flex-col m-4'>
            <div className='flex justify-end'>
                <div className="grid grid-cols-2 gap-4">
                    ...
                    <Button className="btn-success">บันทึก</Button>
                </div>
            ...
            <div className='flex flex-col'>
                ...
                <div className="flex justify-around ">
                    ...
                    {/* <div className="grid grid-cols-2 gap-4 place-content-center">
                        <div className="box-border h-32 w-32 border-4 ">01</div>
                    </div> */}
                </div>
            </div>
                ...
                <table className="table table-pin-rows">
                    ...
                    <tbody>
                        {fabric.list.map((list, index) => (<tr key={index} className="hover">
                            ...
                            <td>
                                <Input name="width" className="input-sm w-16" value={list.width}
                                    onChange={(props: string) => setDatainArray(index, 'width', props)} />
                            </td>
                            <td> <Input name="length" className="input-sm w-16" value={list.length}
                                onChange={(props: string) => setDatainArray(index, 'length', props)} /></td>
                            {/* <td>{list.unit}</td> */}
                            <td><Input name="price_per_unit" className="input-sm w-16" value={list.price_per_unit}
